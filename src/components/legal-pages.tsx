...
const legalCopy: Record<Locale, LegalCopy> = {
  ...
  id: {
    terms: {
      eyebrow: "Ketentuan",
      title: "Ketentuan Layanan UniScribe",
      ...
      sections: [
        ...
        ["Media dan tugas transkripsi", "Pastikan Anda memiliki hak untuk memproses file, tautan, atau rekaman yang dikirim ke UniScribe."],
        ...
        ["Penggunaan yang diterima", "Jangan gunakan UniScribe untuk konten ilegal, pelanggaran hak, otomatisasi berbahaya, atau upaya menghindari batas platform."]
      ]
    },
    privacy: {
      eyebrow: "Privasi",
      title: "Kebijakan Privasi UniScribe",
      description: "Kebijakan ini menjelaskan cara UniScribe menangani informasi akun, media, transkrip, insight AI, pembayaran, dan riwayat penggunaan.",
      sections: [
  ...
  ru: {
    terms: {
      eyebrow: "Условия",
      title: "Условия обслуживания UniScribe",
      ...
      sections: [
        ...
        ["Допустимое использование", "Запрещено использовать UniScribe для незаконного контента, нарушения прав, вредной автоматизации или обхода ограничений платформ."]
      ]
    },
    privacy: {
      eyebrow: "Конфиденциальность",
      title: "Политика конфиденциальности UniScribe",
  ...
  es: {
    terms: {
      eyebrow: "Términos",
      title: "Términos de servicio de UniScribe",
      ...
      sections: [
        ...
        ["Medios y tareas", "Debes tener derecho a procesar los archivos, enlaces o grabaciones que envíes a UniScribe."],
        ...
        ["Uso aceptable", "No uses UniScribe para contenido ilegal, infracción de derechos, automatización maliciosa o evasión de límites."]
      ]
    },
    privacy: {
      eyebrow: "Privacidad",
      title: "Política de privacidad de UniScribe",
      description: "Esta política explica cómo UniScribe trata datos de cuenta, archivos multimedia, transcripciones, insights de IA, pagos y registros de uso.",
      sections: [
  ...
  vi: {
    terms: {
      eyebrow: "Điều khoản",
      title: "Điều khoản dịch vụ UniScribe",
      ...
      sections: [
        ...
        ["Media và tác vụ", "Bạn cần có quyền xử lý các tệp, liên kết hoặc bản ghi gửi lên UniScribe."],
        ...
        ["Sử dụng được chấp nhận", "Không dùng UniScribe cho nội dung bất hợp pháp, xâm phạm quyền, tự động hóa độc hại hoặc né giới hạn nền tảng."]
      ]
    },
    privacy: {
      eyebrow: "Quyền riêng tư",
      title: "Chính sách quyền riêng tư UniScribe",
      description: "Chính sách này mô tả cách UniScribe xử lý thông tin tài khoản, media, bản chép lời, insight AI, thanh toán và lịch sử sử dụng.",
      sections: [
  ...
  ar: {
    terms: {
      ...
      sections: [
        ...
        ["الوسائط والمهام", "يجب أن تملك الحق في معالجة الملفات أو الروابط أو التسجيلات التي ترسلها إلى UniScribe."],
        ...
        ["الاستخدام المقبول", "لا تستخدم UniScribe لمحتوى غير قانوني أو انتهاك حقوق أو أتمتة ضارة أو تجاوز حدود المنصات."]
      ]
    },
    privacy: {
      eyebrow: "الخصوصية",
      title: "سياسة خصوصية UniScribe",
      description: "تشرح هذه السياسة كيفية تعامل UniScribe مع بيانات الحساب والوسائط والنصوص ورؤى الذكاء الاصطناعي والمدفوعات وسجل الاستخدام.",
      sections: [
  ...
  pt: {
    terms: {
      eyebrow: "Termos",
      title: "Termos de Serviço do UniScribe",
      ...
      sections: [
        ...
        ["Mídia e tarefas", "Você deve ter direito de processar os arquivos, links ou gravações enviados ao UniScribe."],
        ...
        ["Uso aceitável", "Não use o UniScribe para conteúdo ilegal, violação de direitos, automação maliciosa ou evasão de limites."]
      ]
    },
    privacy: {
      eyebrow: "Privacidade",
      title: "Política de Privacidade do UniScribe",
      description: "Esta política explica como o UniScribe trata dados de conta, mídia, transcrições, insights de IA, pagamentos e histórico de uso.",
      sections: [
  ...
  fr: {
    terms: {
      eyebrow: "Conditions",
      title: "Conditions d'utilisation de UniScribe",
      ...
      sections: [
        ...
        ["Médias et tâches", "Vous devez disposer du droit de traiter les fichiers, liens ou enregistrements envoyés à UniScribe."],
        ...
        ["Utilisation acceptable", "N'utilisez pas UniScribe pour du contenu illégal, une atteinte aux droits, une automatisation malveillante ou le contournement de limites."]
      ]
    },
    privacy: {
      eyebrow: "Confidentialité",
      title: "Politique de confidentialité UniScribe",
  ...
  "zh-TW": {
    terms: {
      ...
      sections: [
        ...
        ["可接受使用", "不得使用 UniScribe 處理違法內容、侵權素材、惡意自動化或規避平台限制的任務。"]
      ]
    },
    privacy: {
      eyebrow: "隱私權",
      title: "UniScribe 隱私權政策",
      description: "本政策說明 UniScribe 如何處理帳號資訊、媒體檔案、逐字稿、AI 洞察、付款資訊與使用紀錄。",
      sections: [
  ...
  de: {
    terms: {
      eyebrow: "Bedingungen",
      title: "UniScribe Nutzungsbedingungen",
      ...
      sections: [
        ...
        ["Medien und Aufgaben", "Du musst berechtigt sein, Dateien, Links oder Aufnahmen zu verarbeiten, die du an UniScribe sendest."],
        ...
        ["Zulässige Nutzung", "Nutze UniScribe nicht für illegale Inhalte, Rechtsverletzungen, schädliche Automatisierung oder Umgehung von Plattformlimits."]
      ]
    },
    privacy: {
      eyebrow: "Datenschutz",
      title: "UniScribe Datenschutzrichtlinie",
      description: "Diese Richtlinie erklärt, wie UniScribe Kontodaten, Medien, Transkripte, KI-Insights, Zahlungen und Nutzungsdaten verarbeitet.",
      sections: [
  ...
  it: {
    terms: {
      eyebrow: "Termini",
      title: "Termini di servizio UniScribe",
      ...
      sections: [
        ...
        ["Media e attività", "Devi avere il diritto di trattare file, link o registrazioni inviati a UniScribe."],
        ...
        ["Uso accettabile", "Non usare UniScribe per contenuti illegali, violazioni di diritti, automazione dannosa o aggiramento di limiti."]
      ]
    },
    privacy: {
      eyebrow: "Privacy",
      title: "Informativa privacy UniScribe",
      description: "Questa informativa spiega come UniScribe tratta dati account, media, trascrizioni, insight AI, pagamenti e uso.",
      sections: [
  ...
  th: {
    terms: {
      eyebrow: "ข้อกำหนด",
      title: "ข้อกำหนดการให้บริการ UniScribe",
      ...
      sections: [
        ...
        ["สื่อและงานถอดเสียง", "คุณต้องมีสิทธิ์ในการประมวลผลไฟล์ ลิงก์ หรือการบันทึกที่ส่งไปยัง UniScribe"],
        ...
        ["การใช้งานที่ยอมรับได้", "ห้ามใช้ UniScribe กับเนื้อหาผิดกฎหมาย ละเมิดสิทธิ์ ระบบอัตโนมัติที่เป็นอันตราย หรือเลี่ยงข้อจำกัดแพลตฟอร์ม"]
      ]
    },
    privacy: {
      eyebrow: "ความเป็นส่วนตัว",
      title: "นโยบายความเป็นส่วนตัว UniScribe",
      description: "นโยบายนี้อธิบายวิธีที่ UniScribe จัดการข้อมูลบัญชี สื่อ ข้อความถอดเสียง ข้อมูลเชิงลึก AI การชำระเงิน และประวัติการใช้งาน",
      sections: [
  ...
  uk: {
    terms: {
      eyebrow: "Умови",
      title: "Умови обслуговування UniScribe",
      ...
      sections: [
        ...
        ["Медіа і задачі", "Ви повинні мати право обробляти файли, посилання або записи, надіслані до UniScribe."],
        ...
        ["Прийнятне використання", "Не використовуйте UniScribe для незаконного контенту, порушення прав, шкідливої автоматизації або обходу лімітів."]
      ]
    },
    privacy: {
      eyebrow: "Конфіденційність",
      title: "Політика конфіденційності UniScribe",
  ...
  tr: {
    terms: {
      eyebrow: "Şartlar",
      title: "UniScribe Hizmet Şartları",
      ...
      sections: [
        ...
        ["Medya ve görevler", "UniScribe'a gönderdiğiniz dosya, bağlantı veya kayıtları işleme hakkına sahip olmalısınız."],
        ...
        ["Kabul edilebilir kullanım", "UniScribe'ı yasa dışı içerik, hak ihlali, zararlı otomasyon veya platform limitlerini aşmak için kullanmayın."]
      ]
    },
    privacy: {
      eyebrow: "Gizlilik",
      title: "UniScribe Gizlilik Politikası",
      description: "Bu politika UniScribe'ın hesap bilgileri, medya, transkriptler, AI içgörüleri, ödeme ve kullanım geçmişini nasıl işlediğini açıklar.",
      sections: [
  ...
  nl: {
    terms: {
      eyebrow: "Voorwaarden",
      title: "UniScribe Servicevoorwaarden",
      ...
      sections: [
        ...
        ["Media en taken", "Je moet het recht hebben om bestanden, links of opnames die je naar UniScribe stuurt te verwerken."],
        ...
        ["Aanvaardbaar gebruik", "Gebruik UniScribe niet voor illegale content, rechteninbreuk, schadelijke automatisering of het omzeilen van platformlimieten."]
      ]
    },
    privacy: {
      eyebrow: "Privacy",
      title: "UniScribe Privacybeleid",
      description: "Dit beleid legt uit hoe UniScribe accountgegevens, media, transcripties, AI-inzichten, betalingen en gebruiksgeschiedenis verwerkt.",
      sections: [
  ...
  pl: {
    terms: {
      eyebrow: "Warunki",
      title: "Warunki korzystania z UniScribe",
      ...
      sections: [
        ...
        ["Media i zadania", "Musisz mieć prawo do przetwarzania plików, linków lub nagrań wysyłanych do UniScribe."],
        ...
        ["Akceptowalne użycie", "Nie używaj UniScribe do treści nielegalnych, naruszeń praw, szkodliwej automatyzacji ani omijania limitów platform."]
      ]
    },
    privacy: {
      eyebrow: "Prywatność",
      title: "Polityka prywatności UniScribe",
  ...
  hu: {
    terms: {
      eyebrow: "Feltételek",
      title: "UniScribe szolgáltatási feltételek",
      ...
      sections: [
        ...
        ["Média és feladatok", "Jogosultnak kell lenned a UniScribe-nak küldött fájlok, linkek vagy felvételek feldolgozására."],
        ...
        ["Elfogadható használat", "Ne használd a UniScribe-ot illegális tartalomra, jogsértésre, káros automatizálásra vagy platformkorlátok megkerülésére."]
      ]
    },
    privacy: {
      eyebrow: "Adatvédelem",
      title: "UniScribe adatvédelmi irányelvek",
