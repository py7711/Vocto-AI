...
const mediaDownloadNoticeCopy: Record<Locale, string> = {
  ar: "باختيار التنزيل، تقر بأن محتوى الصوت أو الفيديو الذي تصل إليه مخصص للاستخدام الشخصي وغير التجاري فقط. وتوافق على عدم توزيعه أو نسخه أو تعديله أو استخدامه لأي غرض تجاري، بما في ذلك إعادة البيع أو الأداء العلني أو البث. وقد يؤدي أي استخدام خارج هذه الشروط إلى انتهاك قوانين حقوق النشر وشروط الخدمة المعمول بها. نحن غير مسؤولين عن أي استخدام غير مصرح به أو غير ملائم، ويتحمل المستخدم كامل المسؤولية عن الامتثال لجميع الالتزامات القانونية والتعاقدية ذات الصلة.",
  de: "Mit der Auswahl von „Herunterladen“ bestätigen Sie, dass die abgerufenen Audio- oder Videoinhalte ausschließlich für den persönlichen, nicht kommerziellen Gebrauch bestimmt sind. Sie verpflichten sich, die heruntergeladenen Inhalte nicht zu kommerziellen Zwecken zu verbreiten, zu kopieren, zu verändern oder anderweitig zu nutzen, einschließlich Weiterverkauf, öffentlicher Aufführung oder Ausstrahlung. Eine Nutzung außerhalb dieser Bedingungen kann gegen geltendes Urheberrecht und Nutzungsbedingungen verstoßen. Wir übernehmen keine Verantwortung für eine unbefugte oder unsachgemäße Nutzung; Sie sind allein für die Einhaltung aller einschlägigen gesetzlichen und vertraglichen Pflichten verantwortlich.",
  en: "By selecting download, you acknowledge that the audio or video content you access is for personal, non-commercial use only. You agree not to distribute, copy, modify, or otherwise use downloaded content for any commercial purpose, including resale, public performance, or broadcast. Any use beyond these terms may violate applicable copyright laws and terms of service. We accept no responsibility for unauthorized or improper use; you are solely responsible for complying with all relevant legal and contractual obligations.",
  es: "Al seleccionar la descarga, reconoces que el contenido de audio o video al que accedes es solo para uso personal y no comercial. Aceptas no distribuir, copiar, modificar ni utilizar de otro modo el contenido descargado con fines comerciales, incluida su reventa, exhibición pública o emisión. Cualquier uso fuera de estos términos puede infringir las leyes de derechos de autor y los términos de servicio aplicables. No asumimos responsabilidad por usos no autorizados o indebidos; eres el único responsable de cumplir todas las obligaciones legales y contractuales pertinentes.",
  fr: "En sélectionnant le téléchargement, vous reconnaissez que le contenu audio ou vidéo auquel vous accédez est réservé à un usage personnel et non commercial. Vous acceptez de ne pas distribuer, copier, modifier ni utiliser autrement le contenu téléchargé à des fins commerciales, notamment pour la revente, la représentation publique ou la diffusion. Toute utilisation en dehors de ces conditions peut enfreindre les lois applicables sur le droit d’auteur et les conditions de service. Nous déclinons toute responsabilité en cas d’utilisation non autorisée ou inappropriée ; il vous incombe de respecter toutes les obligations légales et contractuelles pertinentes.",
  hu: "A letöltés kiválasztásával tudomásul veszed, hogy az elért hang- vagy videótartalom kizárólag személyes, nem kereskedelmi használatra szolgál. Vállalod, hogy a letöltött tartalmat nem terjeszted, másolod, módosítod és nem használod kereskedelmi célra, ideértve a továbbértékesítést, nyilvános előadást vagy sugárzást. A feltételeken túli felhasználás sértheti az alkalmazandó szerzői jogi szabályokat és szolgáltatási feltételeket. Nem vállalunk felelősséget a jogosulatlan vagy nem megfelelő használatért; minden vonatkozó jogi és szerződéses kötelezettség betartásáért kizárólag te felelsz.",
  id: "Dengan memilih unduh, Anda mengakui bahwa konten audio atau video yang Anda akses hanya untuk penggunaan pribadi dan nonkomersial. Anda setuju untuk tidak mendistribusikan, menyalin, mengubah, atau menggunakan konten yang diunduh untuk tujuan komersial apa pun, termasuk menjual kembali, mempertunjukkan di depan umum, atau menyiarkan. Penggunaan di luar ketentuan ini dapat melanggar undang-undang hak cipta dan ketentuan layanan yang berlaku. Kami tidak bertanggung jawab atas penggunaan tanpa izin atau tidak semestinya; Anda sepenuhnya bertanggung jawab untuk mematuhi semua kewajiban hukum dan kontraktual terkait.",
  it: "Selezionando il download, riconosci che i contenuti audio o video a cui accedi sono destinati esclusivamente a un uso personale e non commerciale. Accetti di non distribuire, copiare, modificare o utilizzare in altro modo i contenuti scaricati per finalità commerciali, inclusi rivendita, esecuzione pubblica o trasmissione. Qualsiasi uso oltre questi termini può violare le leggi sul diritto d’autore e i termini di servizio applicabili. Non ci assumiamo alcuna responsabilità per usi non autorizzati o impropri; sei l’unico responsabile del rispetto di tutti gli obblighi legali e contrattuali pertinenti.",
  ja: "ダウンロードを選択することにより、アクセスする音声または動画コンテンツが個人的かつ非営利目的での使用に限られることを認めるものとします。再販売、公開上演、放送を含む商業目的で、ダウンロードしたコンテンツを配布、複製、改変、その他の方法で使用しないことに同意するものとします。これらの条件を超える利用は、適用される著作権法および利用規約に違反する可能性があります。当社は無断または不適切な利用について責任を負わず、関連するすべての法的および契約上の義務を遵守する責任は利用者が単独で負うものとします。",
  ko: "다운로드를 선택하면 액세스한 오디오 또는 비디오 콘텐츠가 개인적이고 비상업적인 용도로만 사용됨을 인정하는 것입니다. 재판매, 공개 공연 또는 방송을 포함한 어떠한 상업적 목적으로도 다운로드한 콘텐츠를 배포, 복사, 수정하거나 달리 사용하지 않는 데 동의합니다. 이 조건을 벗어난 사용은 관련 저작권법 및 서비스 약관을 위반할 수 있습니다. 당사는 무단 또는 부적절한 사용에 대해 책임지지 않으며, 모든 관련 법적 및 계약상 의무를 준수할 책임은 전적으로 사용자에게 있습니다.",
  nl: "Door downloaden te selecteren, erkent u dat de audio- of videocontent die u opent uitsluitend bestemd is voor persoonlijk, niet-commercieel gebruik. U stemt ermee in gedownloade content niet te verspreiden, kopiëren, wijzigen of anderszins voor commerciële doeleinden te gebruiken, waaronder wederverkoop, openbare uitvoering of uitzending. Gebruik buiten deze voorwaarden kan in strijd zijn met toepasselijke auteursrechtwetten en servicevoorwaarden. Wij aanvaarden geen verantwoordelijkheid voor ongeoorloofd of oneigenlijk gebruik; u bent zelf volledig verantwoordelijk voor de naleving van alle relevante wettelijke en contractuele verplichtingen.",
  pl: "Wybierając pobieranie, potwierdzasz, że uzyskane treści audio lub wideo są przeznaczone wyłącznie do użytku osobistego i niekomercyjnego. Zgadzasz się nie rozpowszechniać, kopiować, modyfikować ani w inny sposób wykorzystywać pobranych treści w celach komercyjnych, w tym do odsprzedaży, publicznego odtwarzania lub nadawania. Użycie wykraczające poza te warunki może naruszać obowiązujące prawa autorskie i warunki korzystania z usług. Nie ponosimy odpowiedzialności za nieautoryzowane lub niewłaściwe wykorzystanie; wyłącznie Ty odpowiadasz za przestrzeganie wszystkich odpowiednich zobowiązań prawnych i umownych.",
  pt: "Ao selecionar o download, você reconhece que o conteúdo de áudio ou vídeo acessado se destina apenas a uso pessoal e não comercial. Você concorda em não distribuir, copiar, modificar ou utilizar de outra forma o conteúdo baixado para qualquer finalidade comercial, incluindo revenda, apresentação pública ou transmissão. Qualquer uso além destes termos pode violar as leis de direitos autorais e os termos de serviço aplicáveis. Não assumimos responsabilidade por uso não autorizado ou impróprio; você é o único responsável por cumprir todas as obrigações legais e contratuais relevantes.",
  ru: "Выбирая загрузку, вы подтверждаете, что доступный вам аудио- или видеоконтент предназначен исключительно для личного некоммерческого использования. Вы соглашаетесь не распространять, не копировать, не изменять и иным образом не использовать загруженный контент в коммерческих целях, включая перепродажу, публичное исполнение или трансляцию. Использование за пределами этих условий может нарушать применимое законодательство об авторском праве и условия обслуживания. Мы не несем ответственности за несанкционированное или ненадлежащее использование; полная ответственность за соблюдение всех соответствующих юридических и договорных обязательств лежит на пользователе.",
  th: "เมื่อเลือกดาวน์โหลด คุณรับทราบว่าเนื้อหาเสียงหรือวิดีโอที่เข้าถึงมีไว้เพื่อการใช้งานส่วนบุคคลและไม่ใช่เชิงพาณิชย์เท่านั้น คุณตกลงว่าจะไม่เผยแพร่ คัดลอก ดัดแปลง หรือใช้เนื้อหาที่ดาวน์โหลดเพื่อวัตถุประสงค์ทางการค้า รวมถึงการขายต่อ การแสดงต่อสาธารณะ หรือการออกอากาศ การใช้งานนอกเหนือจากเงื่อนไขเหล่านี้อาจละเมิดกฎหมายลิขสิทธิ์และข้อกำหนดการให้บริการที่เกี่ยวข้อง เราไม่รับผิดชอบต่อการใช้งานโดยไม่ได้รับอนุญาตหรือไม่เหมาะสม ผู้ใช้ต้องรับผิดชอบแต่เพียงผู้เดียวในการปฏิบัติตามข้อผูกพันทางกฎหมายและสัญญาที่เกี่ยวข้องทั้งหมด",
  tr: "İndirmeyi seçerek eriştiğiniz ses veya video içeriğinin yalnızca kişisel ve ticari olmayan kullanım için olduğunu kabul edersiniz. İndirilen içeriği yeniden satış, halka açık gösterim veya yayın dahil hiçbir ticari amaçla dağıtmamayı, kopyalamamayı, değiştirmemeyi veya başka şekilde kullanmamayı kabul edersiniz. Bu koşulların dışındaki kullanımlar geçerli telif hakkı yasalarını ve hizmet şartlarını ihlal edebilir. Yetkisiz veya uygunsuz kullanımdan sorumlu değiliz; ilgili tüm yasal ve sözleşmesel yükümlülüklere uymaktan yalnızca kullanıcı sorumludur.",
  uk: "Вибираючи завантаження, ви підтверджуєте, що аудіо- чи відеовміст, до якого ви отримуєте доступ, призначений лише для особистого некомерційного використання. Ви погоджуєтеся не розповсюджувати, не копіювати, не змінювати й не використовувати завантажений вміст у комерційних цілях, зокрема для перепродажу, публічного виконання чи трансляції. Використання поза цими умовами може порушувати чинне законодавство про авторське право та умови обслуговування. Ми не несемо відповідальності за несанкціоноване чи неналежне використання; користувач одноосібно відповідає за дотримання всіх відповідних юридичних і договірних зобов’язань.",
  vi: "Khi chọn tải xuống, bạn xác nhận rằng nội dung âm thanh hoặc video được truy cập chỉ dành cho mục đích cá nhân, phi thương mại. Bạn đồng ý không phân phối, sao chép, sửa đổi hoặc sử dụng nội dung đã tải xuống cho bất kỳ mục đích thương mại nào, bao gồm bán lại, trình diễn công khai hoặc phát sóng. Mọi việc sử dụng ngoài các điều khoản này có thể vi phạm luật bản quyền và điều khoản dịch vụ hiện hành. Chúng tôi không chịu trách nhiệm về việc sử dụng trái phép hoặc không phù hợp; người dùng hoàn toàn chịu trách nhiệm tuân thủ mọi nghĩa vụ pháp lý và hợp đồng có liên quan.",
  zh: "选择下载即表示您承认您所访问的音频或视频内容仅供个人和非商业用途。您同意不以任何商业目的分发、复制、修改或以其他方式使用下载的内容，包括但不限于转售、公开表演或广播。超出这些条款范围的任何内容使用可能会导致违反适用的版权法和服务条款。对于任何未经授权或不当使用内容的行为，我们不承担任何责任，用户需对遵守所有相关法律和合同义务承担全部责任。",
  "zh-TW": "選擇下載即表示您承認所存取的音訊或影片內容僅供個人及非商業用途。您同意不以任何商業目的散布、複製、修改或以其他方式使用下載的內容，包括但不限於轉售、公開表演或廣播。超出這些條款範圍的任何內容使用都可能違反適用的著作權法及服務條款。對於任何未經授權或不當使用內容的行為，我們不承擔任何責任；使用者須對遵守所有相關法律及合約義務承擔全部責任。"
};
...
const workspaceTaskActionCopy: Record<Locale, {
  ...
  ar: {cancelFailed: "تعذر إلغاء التفريغ.", canceled: "تم إلغاء التفريغ.", retryFailed: "تعذر إعادة محاولة التفريغ.", retryQueued: "تمت إضافة إعادة المحاولة إلى الصف."},
  de: {cancelFailed: "Transkription konnte nicht abgebrochen werden.", canceled: "Transkription wurde abgebrochen.", retryFailed: "Transkription konnte nicht erneut versucht werden.", retryQueued: "Wiederholungsaufgabe wurde in die Warteschlange gestellt."},
  en: {cancelFailed: "Unable to cancel transcription.", canceled: "Transcription canceled.", retryFailed: "Unable to retry transcription.", retryQueued: "Retry task queued."},
  es: {cancelFailed: "No se pudo cancelar la transcripción.", canceled: "Transcripción cancelada.", retryFailed: "No se pudo reintentar la transcripción.", retryQueued: "Tarea de reintento en cola."},
  fr: {cancelFailed: "Impossible d'annuler la transcription.", canceled: "Transcription annulée.", retryFailed: "Impossible de réessayer la transcription.", retryQueued: "Tâche de nouvelle tentative ajoutée à la file."},
  hu: {cancelFailed: "Az átírás nem szakítható meg.", canceled: "Átírás megszakítva.", retryFailed: "Az átírás újrapróbálása sikertelen.", retryQueued: "Újrapróbálási feladat sorba állítva."},
  id: {cancelFailed: "Tidak dapat membatalkan transkripsi.", canceled: "Transkripsi dibatalkan.", retryFailed: "Tidak dapat mencoba ulang transkripsi.", retryQueued: "Tugas coba ulang masuk antrean."},
  it: {cancelFailed: "Impossibile annullare la trascrizione.", canceled: "Trascrizione annullata.", retryFailed: "Impossibile riprovare la trascrizione.", retryQueued: "Attività di retry in coda."},
  ja: {cancelFailed: "文字起こしをキャンセルできません。", canceled: "文字起こしをキャンセルしました。", retryFailed: "文字起こしを再試行できません。", retryQueued: "再試行タスクをキューに追加しました。"},
  ko: {cancelFailed: "전사를 취소할 수 없습니다.", canceled: "전사가 취소되었습니다.", retryFailed: "전사를 다시 시도할 수 없습니다.", retryQueued: "재시도 작업이 대기열에 추가되었습니다."},
  nl: {cancelFailed: "Kan transcriptie niet annuleren.", canceled: "Transcriptie geannuleerd.", retryFailed: "Kan transcriptie niet opnieuw proberen.", retryQueued: "Retrytaak in wachtrij geplaatst."},
  pl: {cancelFailed: "Nie można anulować transkrypcji.", canceled: "Transkrypcja anulowana.", retryFailed: "Nie można ponowić transkrypcji.", retryQueued: "Zadanie ponowienia dodane do kolejki."},
  pt: {cancelFailed: "Não foi possível cancelar a transcrição.", canceled: "Transcrição cancelada.", retryFailed: "Não foi possível tentar a transcrição novamente.", retryQueued: "Tarefa de nova tentativa na fila."},
  ru: {cancelFailed: "Не удалось отменить расшифровку.", canceled: "Расшифровка отменена.", retryFailed: "Не удалось повторить расшифровку.", retryQueued: "Повторная задача добавлена в очередь."},
  th: {cancelFailed: "ไม่สามารถยกเลิกการถอดเสียงได้", canceled: "ยกเลิกการถอดเสียงแล้ว", retryFailed: "ไม่สามารถลองถอดเสียงอีกครั้งได้", retryQueued: "เพิ่มงานลองใหม่เข้าคิวแล้ว"},
  tr: {cancelFailed: "Transkripsiyon iptal edilemedi.", canceled: "Transkripsiyon iptal edildi.", retryFailed: "Transkripsiyon tekrar denenemedi.", retryQueued: "Tekrar deneme görevi sıraya alındı."},
  uk: {cancelFailed: "Не вдалося скасувати транскрипцію.", canceled: "Транскрипцію скасовано.", retryFailed: "Не вдалося повторити транскрипцію.", retryQueued: "Завдання повтору додано до черги."},
  vi: {cancelFailed: "Không thể hủy bản chép lời.", canceled: "Đã hủy bản chép lời.", retryFailed: "Không thể thử lại bản chép lời.", retryQueued: "Tác vụ thử lại đã vào hàng đợi."},
  zh: {cancelFailed: "无法取消转写。", canceled: "转写已取消。", retryFailed: "无法重试转写。", retryQueued: "重试任务已进入队列。"},
  "zh-TW": {cancelFailed: "無法取消轉寫。", canceled: "轉寫已取消。", retryFailed: "無法重試轉寫。", retryQueued: "重試任務已進入佇列。"}
};
...
export const workspaceCopy = {
  zh: {
    ...
    aiPost: "AI 后处理",
    aiPostText: "完成转写后继续生成摘要、思维导图和翻译，减少手动整理成本。",
  ...
  en: {
    ...
    aiPostText: "After transcription, generate summaries, mind maps, and translations to reduce manual cleanup.",
  ...
  es: {
    ...
    aiPostText: "Después de transcribir, genera resúmenes, mapas mentales, traducciones para reducir el trabajo manual.",
  ...
  fr: {
    ...
    aiPostText: "Après transcription, générez résumés, cartes mentales, traductions pour réduire le nettoyage manuel.",
  ...
  de: {
    ...
    aiPostText: "Erzeuge nach der Transkription Zusammenfassungen, Mindmaps und Übersetzungen, um manuelle Arbeit zu reduzieren.",
  ...
  ja: {
    ...
    aiPost: "AI 後処理",
    aiPostText: "文字起こし後に要約、マインドマップ、翻訳を生成し、手作業の整理を減らします。",
  ...
  ko: {
    ...
    aiPost: "AI 후처리",
    aiPostText: "전사 후 요약, 마인드맵, 번역을 생성해 수작업 정리를 줄입니다.",
...
export function getWorkspaceCopy(locale: string) {
  ...
  return {
    ...
    mediaDownloadNotice: mediaDownloadNoticeCopy[normalizedLocale],
...
export const fallbackMessages: Record<string, string> = {
  ...
  headline: "音视频一键转文字",
  subheadline:
    "上传文件、粘贴视频链接或直接录音。Votxt 会生成可编辑转写、发言人段落、AI 总结、思维导图、翻译和多格式导出。",
  formats: "支持 11+ 媒体格式",
  languages: "支持 63 种语言",
  ...
  workflowExportText: "完成后编辑全文，生成摘要、思维导图、翻译，并下载字幕或文档。",
  insightTitle: "AI 工作区",
