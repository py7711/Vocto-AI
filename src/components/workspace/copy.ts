...
export const plans = [
  ...
  {key: "basicPlan", price: "$6", minutes: "1200", detail: "支持 YouTube、发言人识别、批量任务和 API。"},
  {key: "standardPlan", price: "$12", minutes: "3000", detail: "更高并发、更长文件和优先队列。"},
  {key: "proPlan", price: "$18", minutes: "6000", detail: "面向团队、高频会议和内容生产流水线。"}
];
...
export const workspaceCopy = {
  zh: {
    intlLocale: "zh-CN",
    marketingIntro: "对标 UniScribe 和 VideoTranscriber：首屏即可上传、粘贴链接或录音，不需要先读完营销页。",
    freeSignup: "免费注册",
    viewDashboard: "查看仪表盘",
    converterTools: "转换工具",
    ...
    invite: "邀请",
    create: "创建",
    productionApi: "生产环境 API",
    enterpriseWebhook: "企业 Webhook",
    webhookName: "任务完成回调",
    webhookFailure: (count: number) => `失败 ${count} 次`,
    recentDelivery: "最近投递",
    webhookEmpty: "任务完成、失败和分享链接事件可以推送到外部系统。",
    auditLogs: "审计日志",
    system: "系统",
    auditEmpty: "关键操作会记录在这里。",
    usageLedger: "用量流水",
    plan: "套餐",
    usedThisMonth: "本月已用",
    ...
    refreshTeamError: "无法刷新团队空间。",
    inviteError: "无法邀请团队成员。",
    inviteDone: "团队成员邀请已创建。",
    apiKeyError: "无法创建 API Key。",
    apiKeyDone: "API Key 已创建，明文只会显示这一次。",
    webhookError: "无法创建 Webhook。",
    webhookDone: "Webhook 已创建，签名密钥明文只会显示这一次。",
  ...
  en: {
    intlLocale: "en-US",
    marketingIntro: "Inspired by UniScribe and VideoTranscriber: upload, paste a link, or record immediately without reading a marketing page first.",
    freeSignup: "Sign up free",
    viewDashboard: "View dashboard",
    converterTools: "Converters",
    converters: ["Speech to Text", "Voice to Text", "Audio to Text", "Video to Text", "Link to Text", "MP3 to Text", "MP4 to Text", "WAV to Text"],
    freePlan: "Free plan",
    ...
    enterpriseWebhook: "Enterprise webhook",
    webhookName: "Task callback",
    webhookFailure: (count: number) => `${count} failure${count === 1 ? "" : "s"}`,
    recentDelivery: "Recent delivery",
    webhookEmpty: "Task completed, failed, and share-link events can be pushed to external systems.",
    auditLogs: "Audit logs",
    system: "System",
    auditEmpty: "Important actions will be recorded here.",
    ...
    usageLoginEmpty: "Sign in and initialize a subscription to see team usage, billing period, and recent ledger entries.",
    periodUnset: "Not set",
    whyTitle: "Why Votxt",
    useCases: [
      ["Students and courses", "Turn lectures, online classes, and public videos into searchable notes."],
      ["Meetings and teams", "Preserve the key details from Zoom calls, interviews, training, and customer meetings."],
    ...
    planDetails: {
      ...
      basicPlan: "YouTube links, speaker labels, batch tasks, and API access.",
      standardPlan: "Higher concurrency, longer files, and priority queueing.",
      proPlan: "Built for teams, frequent meetings, and content production pipelines."
    },
    minutesUnit: "min",
    ...
    refreshTeamError: "Unable to refresh team workspace.",
    inviteError: "Unable to invite team member.",
    inviteDone: "Team member invitation created.",
    apiKeyError: "Unable to create API Key.",
    apiKeyDone: "API Key created. The secret is shown only once.",
    webhookError: "Unable to create webhook.",
    webhookDone: "Webhook created. The signing secret is shown only once.",
  ...
  es: {
    intlLocale: "es-ES",
    marketingIntro: "Inspirado en UniScribe y VideoTranscriber: sube, pega un enlace o graba de inmediato sin pasar primero por una página comercial.",
    ...
    memberCount: (count: number) => `${count} miembro${count === 1 ? "" : "s"}`,
    members: "Miembros",
    retention: "Retención",
    days: "días",
    ...
    enterpriseConsole: "Consola empresarial",
    teamMembers: "Miembros del equipo",
    invite: "Invitar",
    create: "Crear",
    productionApi: "API de producción",
    enterpriseWebhook: "Webhook empresarial",
    webhookName: "Callback de tarea",
    webhookFailure: (count: number) => `${count} fallo${count === 1 ? "" : "s"}`,
    recentDelivery: "Entrega reciente",
    webhookEmpty: "Los eventos de tarea completada, fallida y enlace compartido pueden enviarse a sistemas externos.",
    auditLogs: "Registros de auditoría",
    system: "Sistema",
    auditEmpty: "Las acciones importantes se registrarán aquí.",
    usageLedger: "Registro de uso",
    plan: "Plan",
    usedThisMonth: "Usado este mes",
    quotaAdjustment: "Ajuste de cuota",
    usageChange: "Cambio de uso",
    noLedger: "Aún no hay registro de uso. Las tareas de transcripción registrarán reservas, liquidaciones y liberaciones.",
    usageLoginEmpty: "Inicia sesión e inicializa una suscripción para ver uso del equipo, periodo de facturación y movimientos recientes.",
    ...
    useCases: [
      ...
      ["Reuniones y equipos", "Conserva los puntos clave de Zoom, entrevistas, formaciones y reuniones con clientes."],
    ...
    planDetails: {
      ...
      basicPlan: "Enlaces de YouTube, etiquetas de hablante, tareas por lote y acceso API.",
      standardPlan: "Más concurrencia, archivos más largos y cola prioritaria.",
      proPlan: "Para equipos, reuniones frecuentes y flujos de producción de contenido."
    },
    minutesUnit: "min",
    ...
    refreshTeamError: "No se pudo actualizar el espacio de equipo.",
    inviteError: "No se pudo invitar al miembro del equipo.",
    inviteDone: "Invitación de equipo creada.",
    apiKeyError: "No se pudo crear la API Key.",
    apiKeyDone: "API Key creada. El secreto se muestra solo una vez.",
    webhookError: "No se pudo crear el webhook.",
    webhookDone: "Webhook creado. El secreto de firma se muestra solo una vez.",
  ...
  fr: {
    intlLocale: "fr-FR",
    marketingIntro: "Inspiré de UniScribe et VideoTranscriber : importez, collez un lien ou enregistrez immédiatement, sans lire d'abord une page marketing.",
    ...
    enterpriseConsole: "Console entreprise",
    teamMembers: "Membres de l'équipe",
    invite: "Inviter",
    create: "Créer",
    productionApi: "API de production",
    enterpriseWebhook: "Webhook entreprise",
    webhookName: "Callback de tâche",
    webhookFailure: (count: number) => `${count} échec${count === 1 ? "" : "s"}`,
    recentDelivery: "Dernière livraison",
    webhookEmpty: "Les événements de tâche terminée, échouée et lien partagé peuvent être envoyés à des systèmes externes.",
    auditLogs: "Journaux d'audit",
    system: "Système",
    auditEmpty: "Les actions importantes seront enregistrées ici.",
    usageLedger: "Journal d'utilisation",
    plan: "Forfait",
    usedThisMonth: "Utilisé ce mois-ci",
    quotaAdjustment: "Ajustement du quota",
    usageChange: "Variation d'utilisation",
    ...
    usageLoginEmpty: "Connectez-vous et initialisez un abonnement pour voir l'utilisation d'équipe, la période de facturation et les mouvements récents.",
    ...
    useCases: [
      ...
      ["Réunions et équipes", "Conservez les détails clés de Zoom, interviews, formations et réunions client."],
    ...
    planDetails: {
      ...
      basicPlan: "Liens YouTube, étiquettes d'intervenants, tâches par lot et accès API.",
      standardPlan: "Plus de concurrence, fichiers plus longs et file prioritaire.",
      proPlan: "Conçu pour les équipes, réunions fréquentes et chaînes de production de contenu."
    },
    minutesUnit: "min",
    ...
    refreshTeamError: "Impossible d'actualiser l'espace équipe.",
    inviteError: "Impossible d'inviter le membre de l'équipe.",
    inviteDone: "Invitation d'équipe créée.",
    apiKeyError: "Impossible de créer l'API Key.",
    apiKeyDone: "API Key créée. Le secret n'est affiché qu'une seule fois.",
    webhookError: "Impossible de créer le webhook.",
    webhookDone: "Webhook créé. Le secret de signature n'est affiché qu'une seule fois.",
  ...
  de: {
    intlLocale: "de-DE",
    marketingIntro: "Inspiriert von UniScribe und VideoTranscriber: sofort hochladen, Link einfügen oder aufnehmen, ohne zuerst eine Marketingseite zu lesen.",
    ...
    teamSpace: "Team-Arbeitsbereich",
    defaultTeam: "Standardteam",
    memberCount: (count: number) => `${count} Mitglied${count === 1 ? "" : "er"}`,
    members: "Mitglieder",
    ...
    enterpriseConsole: "Enterprise-Konsole",
    teamMembers: "Teammitglieder",
    invite: "Einladen",
    create: "Erstellen",
    productionApi: "Produktions-API",
    enterpriseWebhook: "Enterprise-Webhook",
    webhookName: "Aufgaben-Callback",
    webhookFailure: (count: number) => `${count} Fehler`,
    recentDelivery: "Letzte Zustellung",
    webhookEmpty: "Ereignisse für abgeschlossene, fehlgeschlagene Aufgaben und geteilte Links können an externe Systeme gesendet werden.",
    auditLogs: "Audit-Logs",
    system: "System",
    auditEmpty: "Wichtige Aktionen werden hier protokolliert.",
    usageLedger: "Nutzungsprotokoll",
    plan: "Plan",
    usedThisMonth: "Diesen Monat genutzt",
    quotaAdjustment: "Kontingent-Anpassung",
    usageChange: "Nutzungsänderung",
    noLedger: "Noch kein Nutzungsprotokoll. Transkriptionsaufgaben erfassen Reservierung, Abrechnung und Freigabe.",
    usageLoginEmpty: "Melde dich an und initialisiere ein Abo, um Teamnutzung, Abrechnungszeitraum und aktuelle Einträge zu sehen.",
    ...
    useCases: [
      ...
      ["Meetings und Teams", "Bewahre wichtige Details aus Zoom-Calls, Interviews, Trainings und Kundengesprächen."],
    ...
    planDetails: {
      ...
      basicPlan: "YouTube-Links, Sprecherlabels, Batch-Aufgaben und API-Zugriff.",
      standardPlan: "Mehr Parallelität, längere Dateien und priorisierte Warteschlange.",
      proPlan: "Für Teams, häufige Meetings und Content-Produktionsabläufe."
    },
    minutesUnit: "Min.",
    ...
    refreshTeamError: "Team-Arbeitsbereich konnte nicht aktualisiert werden.",
    inviteError: "Teammitglied konnte nicht eingeladen werden.",
    inviteDone: "Teameinladung erstellt.",
    apiKeyError: "API Key konnte nicht erstellt werden.",
    apiKeyDone: "API Key erstellt. Das Geheimnis wird nur einmal angezeigt.",
    webhookError: "Webhook konnte nicht erstellt werden.",
    webhookDone: "Webhook erstellt. Das Signaturgeheimnis wird nur einmal angezeigt.",
  ...
  ja: {
    intlLocale: "ja-JP",
    marketingIntro: "UniScribe と VideoTranscriber に着想。マーケティングページを読まなくても、すぐにアップロード、リンク貼り付け、録音を開始できます。",
    freeSignup: "無料登録",
    ...
    enterpriseConsole: "エンタープライズコンソール",
    teamMembers: "チームメンバー",
    invite: "招待",
    create: "作成",
    productionApi: "本番 API",
    enterpriseWebhook: "エンタープライズ Webhook",
    webhookName: "タスク完了コールバック",
    webhookFailure: (count: number) => `失敗 ${count} 回`,
    recentDelivery: "最近の配信",
    webhookEmpty: "タスク完了、失敗、共有リンク作成イベントを外部システムへ送信できます。",
    auditLogs: "監査ログ",
    system: "システム",
    auditEmpty: "重要な操作はここに記録されます。",
    usageLedger: "利用履歴",
    plan: "プラン",
    usedThisMonth: "今月の使用量",
    quotaAdjustment: "利用枠調整",
    usageChange: "利用量変更",
    noLedger: "利用履歴はまだありません。文字起こしタスク作成後に予約、確定、解放が記録されます。",
    usageLoginEmpty: "ログインしてサブスクリプションを初期化すると、チーム利用状況、請求期間、最近の履歴が表示されます。",
    periodUnset: "未設定",
    whyTitle: "Votxt が選ばれる理由",
    useCases: [
      ["学生と授業", "講義、オンライン授業、公開動画を検索可能なノートに変換します。"],
      ["会議とチーム", "Zoom、インタビュー、研修、顧客会議の重要ポイントを保存します。"],
      ["クリエイター", "動画から字幕、台本、ブログ下書き、SNS 素材を作成します。"],
      ["調査とメディア", "インタビュー、オーラルヒストリー、ポッドキャスト、記者会見を素早く処理します。"]
    ],
    planDetails: {
      freePlan: "1日3ファイル、1ファイル30分まで。軽い試用に最適です。",
      basicPlan: "YouTube リンク、話者ラベル、バッチタスク、API アクセスに対応。",
      standardPlan: "同時処理数、長時間ファイル、優先キューを強化。",
      proPlan: "チーム、高頻度の会議、コンテンツ制作パイプライン向け。"
    },
    minutesUnit: "分",
    ...
    refreshTeamError: "チームワークスペースを更新できません。",
    inviteError: "チームメンバーを招待できません。",
    inviteDone: "チーム招待を作成しました。",
    apiKeyError: "API Key を作成できません。",
    apiKeyDone: "API Key を作成しました。シークレットは一度だけ表示されます。",
    webhookError: "Webhook を作成できません。",
    webhookDone: "Webhook を作成しました。署名シークレットは一度だけ表示されます。",
  ...
  ko: {
    intlLocale: "ko-KR",
    marketingIntro: "UniScribe와 VideoTranscriber에서 착안했습니다. 마케팅 페이지를 읽지 않아도 바로 업로드, 링크 붙여넣기, 녹음을 시작할 수 있습니다.",
    freeSignup: "무료 가입",
    ...
    teamSpace: "팀 워크스페이스",
    defaultTeam: "기본 팀",
    memberCount: (count: number) => `${count}명 멤버`,
    members: "멤버",
    retention: "보관 기간",
    days: "일",
    monthTasks: "이번 달 작업",
    ...
    enterpriseConsole: "엔터프라이즈 콘솔",
    teamMembers: "팀 멤버",
    invite: "초대",
    create: "생성",
    productionApi: "프로덕션 API",
    enterpriseWebhook: "엔터프라이즈 Webhook",
    webhookName: "작업 콜백",
    webhookFailure: (count: number) => `${count}회 실패`,
    recentDelivery: "최근 전달",
    webhookEmpty: "작업 완료, 실패, 공유 링크 이벤트를 외부 시스템으로 전송할 수 있습니다.",
    auditLogs: "감사 로그",
    system: "시스템",
    auditEmpty: "중요한 작업은 여기에 기록됩니다.",
    usageLedger: "사용량 내역",
    plan: "플랜",
    usedThisMonth: "이번 달 사용량",
    quotaAdjustment: "할당량 조정",
    usageChange: "사용량 변경",
    noLedger: "아직 사용량 내역이 없습니다. 전사 작업 생성 후 예약, 정산, 해제가 기록됩니다.",
    usageLoginEmpty: "로그인하고 구독을 초기화하면 팀 사용량, 청구 기간, 최근 내역을 볼 수 있습니다.",
    periodUnset: "미설정",
    whyTitle: "Votxt를 선택하는 이유",
    useCases: [
      ["학생과 강의", "강의, 온라인 수업, 공개 영상을 검색 가능한 노트로 바꿉니다."],
      ["회의와 팀", "Zoom, 인터뷰, 교육, 고객 회의의 핵심 내용을 보존합니다."],
      ["크리에이터", "영상에서 자막, 스크립트, 블로그 초안, 소셜 콘텐츠를 만듭니다."],
      ["리서치와 미디어", "인터뷰, 구술 기록, 팟캐스트, 기자회견을 더 빠르게 처리합니다."]
    ],
    planDetails: {
      freePlan: "하루 3개 파일, 파일당 30분. 가벼운 체험에 적합합니다.",
      basicPlan: "YouTube 링크, 화자 라벨, 일괄 작업, API 접근을 지원합니다.",
      standardPlan: "더 높은 동시 처리, 더 긴 파일, 우선 대기열을 제공합니다.",
      proPlan: "팀, 잦은 회의, 콘텐츠 제작 파이프라인에 적합합니다."
    },
    minutesUnit: "분",
    ...
    refreshTeamError: "팀 워크스페이스를 새로고침할 수 없습니다.",
    inviteError: "팀 멤버를 초대할 수 없습니다.",
    inviteDone: "팀 초대를 만들었습니다.",
    apiKeyError: "API Key를 만들 수 없습니다.",
    apiKeyDone: "API Key가 생성되었습니다. 비밀값은 한 번만 표시됩니다.",
    webhookError: "Webhook을 만들 수 없습니다.",
    webhookDone: "Webhook이 생성되었습니다. 서명 비밀값은 한 번만 표시됩니다.",
  ...
  pt: {
    intlLocale: "pt-BR",
    marketingIntro: "Inspirado no UniScribe e no VideoTranscriber: envie, cole um link ou grave imediatamente, sem passar primeiro por uma página de marketing.",
    ...
    defaultTeam: "Equipe padrão",
    memberCount: (count: number) => `${count} membro${count === 1 ? "" : "s"}`,
    members: "Membros",
    retention: "Retenção",
    days: "dias",
    ...
    enterpriseConsole: "Console empresarial",
    teamMembers: "Membros da equipe",
    invite: "Convidar",
    create: "Criar",
    productionApi: "API de produção",
    enterpriseWebhook: "Webhook empresarial",
    webhookName: "Callback de tarefa",
    webhookFailure: (count: number) => `${count} falha${count === 1 ? "" : "s"}`,
    recentDelivery: "Entrega recente",
    webhookEmpty: "Eventos de tarefa concluída, falha e link compartilhado podem ser enviados para sistemas externos.",
    auditLogs: "Logs de auditoria",
    system: "Sistema",
    auditEmpty: "Ações importantes serão registradas aqui.",
    usageLedger: "Histórico de uso",
    plan: "Plano",
    usedThisMonth: "Usado este mês",
    quotaAdjustment: "Ajuste de cota",
    usageChange: "Mudança de uso",
    noLedger: "Ainda não há histórico de uso. Tarefas de transcrição registrarão reserva, liquidação e liberação.",
    usageLoginEmpty: "Entre e inicialize uma assinatura para ver uso da equipe, período de cobrança e histórico recente.",
    ...
    useCases: [
      ...
      ["Reuniões e equipes", "Preserve detalhes importantes de Zoom, entrevistas, treinamentos e reuniões com clientes."],
    ...
    planDetails: {
      ...
      basicPlan: "Links do YouTube, rótulos de locutor, tarefas em lote e acesso API.",
      standardPlan: "Mais concorrência, arquivos mais longos e fila prioritária.",
      proPlan: "Para equipes, reuniões frequentes e pipelines de produção de conteúdo."
    },
    minutesUnit: "min",
    ...
    refreshTeamError: "Não foi possível atualizar o espaço da equipe.",
    inviteError: "Não foi possível convidar o membro da equipe.",
    inviteDone: "Convite da equipe criado.",
    apiKeyError: "Não foi possível criar a API Key.",
    apiKeyDone: "API Key criada. O segredo é exibido apenas uma vez.",
    webhookError: "Não foi possível criar o webhook.",
    webhookDone: "Webhook criado. O segredo de assinatura é exibido apenas uma vez.",
...
export function getWorkspaceCopy(locale: string) {
  ...
  return workspaceCopy[localeKey] ?? workspaceCopy.en;
}
...
export const fallbackMessages: Record<string, string> = {
  ...
  localUploadHint: "音频: aac, flac, m4a, mp3, opus, wav, webm。视频: mkv, mov, mp4, webm, wmv。",
