...
const infoCopy: Record<Locale, LocaleInfoCopy> = {
  ar: {
    security: {
      ...
      description: "تعرّف على طريقة حماية UniScribe لملفاتك ونصوصك وروابط المشاركة والمدفوعات.",
      sections: [
        ...
        ["المدفوعات", "تتم المدفوعات عبر Stripe، ولا تخزن UniScribe بيانات بطاقتك على خوادمها."],
    ...
    affiliate: {
      eyebrow: "الشراكة",
      title: "برنامج شركاء UniScribe",
      description: "اكسب عمولة 30% عند تعريف جمهورك بأدوات تحويل الصوت والفيديو إلى نص وملاحظات ذكية.",
      sections: [
        ["لجمهور مناسب", "UniScribe مفيد للفرق والأفراد الذين يحولون الاجتماعات والمقابلات والدروس والبودكاست والفيديوهات إلى مستندات."],
        ["انضم إلى البرنامج", "أنشئ حسابك في Rewardful واحصل على رابط الإحالة الخاص بك."],
        ["شارك UniScribe", "روّج للنسخ والتلخيص والخرائط الذهنية والترجمة وتصدير الملفات."],
      ...
      ctaText: "أنشئ حساب الشريك، واحصل على رابطك، وابدأ بمشاركة UniScribe مع من يعملون بالصوت والفيديو.",
      join: "انضم إلى برنامج الشركاء",
      login: "دخول الشركاء",
      faqTitle: "هل أنت مستعد لتصبح شريكا في UniScribe؟",
  ...
  de: {
    security: {
      ...
      description: "Erfahre, wie UniScribe deine Dateien, Transkripte, Freigabelinks und Zahlungen schützt.",
      sections: [
        ...
        ["Zahlungen", "Zahlungen verarbeitet Stripe. UniScribe speichert keine Kreditkartendaten auf eigenen Servern."],
    ...
    affiliate: {
      eyebrow: "Affiliate",
      title: "UniScribe Affiliate-Programm",
      description: "Verdiene 30% Provision, wenn du UniScribe Menschen empfiehlst, die Audio und Video in Text und KI-Notizen verwandeln.",
      sections: [
        ["Für relevante Zielgruppen", "UniScribe hilft Teams und Einzelpersonen, Meetings, Interviews, Vorlesungen, Podcasts und Videos in nutzbare Dokumente zu verwandeln."],
        ["Programm beitreten", "Erstelle dein Rewardful-Konto und erhalte deinen persönlichen UniScribe-Empfehlungslink."],
        ["UniScribe teilen", "Bewirb Transkription, Zusammenfassungen, Mindmaps, Übersetzung und Export-Workflows."],
      ...
      ctaText: "Erstelle dein Affiliate-Konto, hole deinen Link und teile UniScribe mit Menschen, die mit Audio und Video arbeiten.",
      join: "Affiliate-Programm beitreten",
      login: "Affiliate-Login",
      faqTitle: "Bereit, UniScribe Affiliate zu werden?",
  ...
  en: {
    security: {
      ...
      description: "Learn how UniScribe protects your files, transcripts, share links, and payments.",
      sections: [
        ...
        ["Payments", "Payments are processed by Stripe. UniScribe does not store your card details on its servers."],
    ...
    affiliate: {
      ...
      description: "Earn 30% commission by introducing UniScribe to people who need audio and video transcription, AI notes, and export workflows.",
      sections: [
        ["Built for relevant audiences", "UniScribe is useful for teams and individuals who turn meetings, interviews, lectures, podcasts, and videos into usable documents."],
        ["Join the program", "Create your Rewardful affiliate account and get your unique UniScribe referral link."],
        ["Share UniScribe", "Promote transcription, summaries, mind maps, translation, subtitles, and document exports."],
      ...
      ctaText: "Create your Rewardful affiliate account, get your link, and start sharing UniScribe with people who work with audio and video.",
      join: "Join the affiliate program",
      login: "Affiliate login",
      faqTitle: "Ready to become a UniScribe affiliate?",
  ...
  es: {
    security: {
      ...
      description: "Conoce cómo UniScribe protege tus archivos, transcripciones, enlaces compartidos y pagos.",
      sections: [
        ...
        ["Pagos", "Stripe procesa los pagos. UniScribe no guarda los datos de tu tarjeta en sus servidores."],
    ...
    affiliate: {
      eyebrow: "Afiliados",
      title: "Programa de afiliados de UniScribe",
      description: "Gana 30% de comisión recomendando UniScribe a quienes necesitan transcripción de audio y video, notas con IA y exportaciones.",
      sections: [
        ["Para audiencias relevantes", "UniScribe ayuda a equipos y personas que convierten reuniones, entrevistas, clases, podcasts y videos en documentos útiles."],
        ["Únete al programa", "Crea tu cuenta de afiliado en Rewardful y obtén tu enlace único de UniScribe."],
        ["Comparte UniScribe", "Promociona transcripción, resúmenes, mapas mentales, traducción, subtítulos y exportación de documentos."],
      ...
      ctaText: "Crea tu cuenta de afiliado, consigue tu enlace y empieza a compartir UniScribe con personas que trabajan con audio y video.",
      join: "Unirse al programa",
      login: "Acceso de afiliados",
      faqTitle: "¿Listo para ser afiliado de UniScribe?",
  ...
  fr: {
    security: {
      ...
      description: "Découvrez comment UniScribe protège vos fichiers, transcriptions, liens partagés et paiements.",
      sections: [
        ...
        ["Paiements", "Les paiements sont traités par Stripe. UniScribe ne stocke pas les données de carte sur ses serveurs."],
    ...
    affiliate: {
      eyebrow: "Affiliation",
      title: "Programme d'affiliation UniScribe",
      description: "Gagnez 30% de commission en recommandant UniScribe aux personnes qui ont besoin de transcription audio et vidéo, notes IA et exports.",
      sections: [
        ["Pour les audiences pertinentes", "UniScribe aide les équipes et les personnes qui transforment réunions, interviews, cours, podcasts et vidéos en documents utiles."],
        ["Rejoindre le programme", "Créez votre compte Rewardful et obtenez votre lien de parrainage UniScribe unique."],
        ["Partager UniScribe", "Promouvez transcription, résumés, cartes mentales, traduction, sous-titres et exports de documents."],
      ...
      ctaText: "Créez votre compte affilié, récupérez votre lien et partagez UniScribe avec les personnes qui travaillent avec l'audio et la vidéo.",
      join: "Rejoindre le programme",
      login: "Connexion affilié",
      faqTitle: "Prêt à devenir affilié UniScribe ?",
  ...
  hu: {
    security: {
      ...
      description: "Ismerd meg, hogyan védi a UniScribe a fájljaidat, átirataidat, megosztási linkjeidet és fizetéseidet.",
      sections: [
        ...
        ["Fizetések", "A fizetéseket a Stripe kezeli. A UniScribe nem tárol bankkártyaadatokat a szerverein."],
    ...
    affiliate: {
      ...
      title: "UniScribe partnerprogram",
      description: "Keress 30% jutalékot, ha UniScribe-ot ajánlasz olyanoknak, akik hang- és videóátiratot, AI jegyzeteket és exportokat keresnek.",
      sections: [
        ["Releváns közönségeknek", "A UniScribe csapatoknak és egyéneknek segít megbeszélések, interjúk, előadások, podcastek és videók dokumentummá alakításában."],
        ["Csatlakozás", "Hozd létre Rewardful partnerfiókodat, és szerezd meg egyedi UniScribe ajánlólinkedet."],
        ["UniScribe megosztása", "Népszerűsítsd az átiratokat, összefoglalókat, gondolattérképeket, fordítást, feliratokat és dokumentumexportot."],
      ...
      ctaText: "Hozd létre partnerfiókodat, szerezd meg linkedet, és oszd meg a UniScribe-ot hanggal és videóval dolgozó emberekkel.",
      join: "Csatlakozás a programhoz",
      login: "Partner belépés",
      faqTitle: "Készen állsz UniScribe partnerré válni?",
  ...
  id: {
    security: {
      ...
      description: "Pelajari cara UniScribe melindungi file, transkrip, tautan berbagi, dan pembayaran Anda.",
      sections: [
        ...
        ["Pembayaran", "Pembayaran diproses oleh Stripe. UniScribe tidak menyimpan detail kartu di servernya."],
    ...
    affiliate: {
      eyebrow: "Afiliasi",
      title: "Program Afiliasi UniScribe",
      description: "Dapatkan komisi 30% dengan memperkenalkan UniScribe kepada orang yang membutuhkan transkripsi audio dan video, catatan AI, dan ekspor.",
      sections: [
        ["Untuk audiens relevan", "UniScribe membantu tim dan individu mengubah rapat, wawancara, kuliah, podcast, dan video menjadi dokumen yang berguna."],
        ["Bergabung", "Buat akun afiliasi Rewardful dan dapatkan tautan referensi UniScribe unik Anda."],
        ["Bagikan UniScribe", "Promosikan transkripsi, ringkasan, mind map, terjemahan, subtitle, dan ekspor dokumen."],
      ...
      ctaText: "Buat akun afiliasi Anda, dapatkan tautan, dan mulai bagikan UniScribe kepada orang yang bekerja dengan audio dan video.",
      join: "Bergabung dengan program afiliasi",
      login: "Login afiliasi",
      faqTitle: "Siap menjadi afiliasi UniScribe?",
  ...
  it: {
    security: {
      ...
      description: "Scopri come UniScribe protegge file, trascrizioni, link condivisi e pagamenti.",
      sections: [
        ...
        ["Pagamenti", "I pagamenti sono gestiti da Stripe. UniScribe non conserva i dati della carta sui propri server."],
    ...
    affiliate: {
      ...
      title: "Programma affiliati UniScribe",
      description: "Guadagna il 30% di commissione presentando UniScribe a chi ha bisogno di trascrizione audio e video, note AI ed esportazioni.",
      sections: [
        ["Per audience rilevanti", "UniScribe aiuta team e persone a trasformare riunioni, interviste, lezioni, podcast e video in documenti utilizzabili."],
        ["Unisciti al programma", "Crea il tuo account Rewardful e ottieni il link referral UniScribe unico."],
        ["Condividi UniScribe", "Promuovi trascrizione, riepiloghi, mappe mentali, traduzione, sottotitoli ed export documenti."],
      ...
      ctaText: "Crea il tuo account affiliato, ottieni il link e condividi UniScribe con chi lavora con audio e video.",
      join: "Unisciti al programma",
      login: "Login affiliati",
      faqTitle: "Pronto a diventare affiliato UniScribe?",
  ...
  ja: {
    security: {
      eyebrow: "セキュリティ",
      title: "セキュリティとプライバシー",
      description: "UniScribe がファイル、文字起こし、共有リンク、支払いをどのように保護するかをご確認ください。",
      sections: [
        ["データ暗号化", "メディアファイルと文字起こしは保存時に暗号化され、転送には安全な HTTPS 接続を使用します。"],
        ["アカウントアクセス", "ファイルはアカウントに紐づきます。読み取り専用の共有リンクを作成した場合のみ公開されます。"],
        ["支払い", "支払いは Stripe が処理します。UniScribe はカード情報をサーバーに保存しません。"],
        ["AI 処理", "AI プロバイダーには依頼された処理に必要なメディアまたはテキストのみ送信されます。明示的な同意なしに AI 学習へ使用しません。"]
      ]
    },
    affiliate: {
      eyebrow: "アフィリエイト",
      title: "UniScribe アフィリエイトプログラム",
      description: "音声・動画の文字起こし、AI ノート、エクスポートが必要な人に UniScribe を紹介して 30% のコミッションを獲得できます。",
      sections: [
        ["関連する audience 向け", "UniScribe は会議、インタビュー、講義、ポッドキャスト、動画を使える文書に変換するチームや個人に役立ちます。"],
        ["プログラム参加", "Rewardful のアフィリエイトアカウントを作成し、専用の UniScribe 紹介リンクを取得します。"],
        ["UniScribe を共有", "文字起こし、要約、マインドマップ、翻訳、字幕、文書エクスポートを紹介できます。"],
      ...
      ctaText: "アフィリエイトアカウントを作成し、リンクを取得して、音声や動画を扱う人に UniScribe を共有しましょう。",
      join: "アフィリエイトに参加",
      login: "アフィリエイトログイン",
      faqTitle: "UniScribe アフィリエイトを始めますか？",
  ...
  ko: {
    security: {
      eyebrow: "보안",
      title: "보안 및 개인정보",
      description: "UniScribe가 파일, 전사, 공유 링크, 결제를 어떻게 보호하는지 확인하세요.",
      sections: [
        ["데이터 암호화", "미디어 파일과 전사는 저장 시 암호화되며 전송에는 안전한 HTTPS 연결을 사용합니다."],
        ["계정 접근", "파일은 계정 범위에 유지됩니다. 읽기 전용 공유 링크를 만들 때만 공개됩니다."],
        ["결제", "결제는 Stripe가 처리합니다. UniScribe는 카드 정보를 서버에 저장하지 않습니다."],
        ["AI 처리", "AI 제공업체는 요청한 작업에 필요한 미디어 또는 텍스트만 받습니다. 명시적 동의 없이 AI 학습에 사용하지 않습니다."]
      ]
    },
    affiliate: {
      eyebrow: "제휴",
      title: "UniScribe 제휴 프로그램",
      description: "오디오 및 비디오 전사, AI 노트, 내보내기가 필요한 사람들에게 UniScribe를 소개하고 30% 커미션을 받으세요.",
      sections: [
        ["관련 audience를 위해", "UniScribe는 회의, 인터뷰, 강의, 팟캐스트, 비디오를 활용 가능한 문서로 바꾸는 팀과 개인에게 유용합니다."],
        ["프로그램 참여", "Rewardful 제휴 계정을 만들고 고유 UniScribe 추천 링크를 받으세요."],
        ["UniScribe 공유", "전사, 요약, 마인드맵, 번역, 자막, 문서 내보내기를 홍보하세요."],
        ["커미션 받기", "추천 고객 결제의 30%를 첫 12개월 동안 받을 수 있습니다."]
      ],
      stats: [["커미션", "30%", "추천 고객 결제 기준"], ["기간", "12개월", "고객별 커미션 기간"], ["추적", "Rewardful", "추천 링크, 전환, 환불, 지급 추적"]],
      ctaText: "제휴 계정을 만들고 링크를 받아 오디오와 비디오를 다루는 사람들에게 UniScribe를 공유하세요.",
      join: "제휴 프로그램 참여",
      login: "제휴 로그인",
      faqTitle: "UniScribe 제휴 파트너가 될 준비가 되셨나요?",
  ...
  nl: {
    security: {
      ...
      description: "Lees hoe UniScribe je bestanden, transcripties, deellinks en betalingen beschermt.",
      sections: [
        ...
        ["Betalingen", "Betalingen worden verwerkt door Stripe. UniScribe bewaart geen kaartgegevens op eigen servers."],
    ...
    affiliate: {
      eyebrow: "Affiliate",
      title: "UniScribe affiliateprogramma",
      description: "Verdien 30% commissie door UniScribe te introduceren bij mensen die audio- en videotranscriptie, AI-notities en exports nodig hebben.",
      sections: [
        ["Voor relevante doelgroepen", "UniScribe helpt teams en individuen vergaderingen, interviews, colleges, podcasts en video's om te zetten in bruikbare documenten."],
        ["Doe mee", "Maak je Rewardful affiliateaccount aan en ontvang je unieke UniScribe verwijzingslink."],
        ["Deel UniScribe", "Promoot transcriptie, samenvattingen, mindmaps, vertaling, ondertitels en documentexports."],
      ...
      ctaText: "Maak je affiliateaccount, ontvang je link en deel UniScribe met mensen die met audio en video werken.",
      join: "Word affiliate",
      login: "Affiliate login",
      faqTitle: "Klaar om UniScribe affiliate te worden?",
  ...
  pl: {
    security: {
      ...
      description: "Dowiedz się, jak UniScribe chroni pliki, transkrypcje, linki udostępniania i płatności.",
      sections: [
        ...
        ["Płatności", "Płatności obsługuje Stripe. UniScribe nie przechowuje danych karty na swoich serwerach."],
    ...
    affiliate: {
      eyebrow: "Afiliacja",
      title: "Program afiliacyjny UniScribe",
      description: "Zarabiaj 30% prowizji, polecając UniScribe osobom potrzebującym transkrypcji audio i wideo, notatek AI oraz eksportu.",
      sections: [
        ["Dla właściwych odbiorców", "UniScribe pomaga zespołom i osobom zamieniać spotkania, wywiady, wykłady, podcasty i filmy w użyteczne dokumenty."],
        ["Dołącz do programu", "Utwórz konto afiliacyjne Rewardful i otrzymaj unikalny link polecający UniScribe."],
        ["Udostępniaj UniScribe", "Promuj transkrypcję, podsumowania, mapy myśli, tłumaczenia, napisy i eksport dokumentów."],
      ...
      ctaText: "Utwórz konto afiliacyjne, pobierz link i udostępniaj UniScribe osobom pracującym z audio i wideo.",
      join: "Dołącz do programu",
      login: "Logowanie afilianta",
      faqTitle: "Gotowy zostać afiliantem UniScribe?",
  ...
  pt: {
    security: {
      ...
      description: "Saiba como a UniScribe protege seus arquivos, transcrições, links compartilhados e pagamentos.",
      sections: [
        ...
        ["Pagamentos", "Pagamentos são processados pela Stripe. A UniScribe não armazena dados do cartão em seus servidores."],
    ...
    affiliate: {
      eyebrow: "Afiliados",
      title: "Programa de Afiliados UniScribe",
      description: "Ganhe 30% de comissão apresentando a UniScribe a pessoas que precisam de transcrição de áudio e vídeo, notas com IA e exportações.",
      sections: [
        ["Para audiências relevantes", "A UniScribe ajuda equipes e indivíduos a transformar reuniões, entrevistas, aulas, podcasts e vídeos em documentos úteis."],
        ["Participe", "Crie sua conta de afiliado na Rewardful e receba seu link único da UniScribe."],
        ["Compartilhe a UniScribe", "Promova transcrição, resumos, mapas mentais, tradução, legendas e exportação de documentos."],
      ...
      ctaText: "Crie sua conta de afiliado, pegue seu link e compartilhe a UniScribe com pessoas que trabalham com áudio e vídeo.",
      join: "Entrar no programa",
      login: "Login de afiliado",
      faqTitle: "Pronto para ser afiliado da UniScribe?",
  ...
  ru: {
    security: {
      ...
      description: "Узнайте, как UniScribe защищает ваши файлы, расшифровки, ссылки доступа и платежи.",
      sections: [
        ...
        ["Платежи", "Платежи обрабатывает Stripe. UniScribe не хранит данные карты на своих серверах."],
    ...
    affiliate: {
      ...
      title: "Партнерская программа UniScribe",
      description: "Получайте 30% комиссии, рекомендуя UniScribe людям, которым нужны расшифровка аудио и видео, AI-заметки и экспорт.",
      sections: [
        ["Для релевантной аудитории", "UniScribe помогает командам и отдельным пользователям превращать встречи, интервью, лекции, подкасты и видео в полезные документы."],
        ["Присоединиться", "Создайте партнерский аккаунт Rewardful и получите уникальную ссылку UniScribe."],
        ["Делиться UniScribe", "Продвигайте расшифровку, резюме, интеллект-карты, перевод, субтитры и экспорт документов."],
      ...
      ctaText: "Создайте партнерский аккаунт, получите ссылку и делитесь UniScribe с людьми, работающими с аудио и видео.",
      join: "Стать партнером",
      login: "Вход для партнеров",
      faqTitle: "Готовы стать партнером UniScribe?",
  ...
  th: {
    security: {
      ...
      description: "ดูว่า UniScribe ปกป้องไฟล์ ข้อความถอดเสียง ลิงก์แชร์ และการชำระเงินของคุณอย่างไร",
      sections: [
        ...
        ["การชำระเงิน", "Stripe เป็นผู้ประมวลผลการชำระเงิน UniScribe ไม่เก็บข้อมูลบัตรบนเซิร์ฟเวอร์ของตน"],
    ...
    affiliate: {
      eyebrow: "พันธมิตร",
      title: "โปรแกรมพันธมิตร UniScribe",
      description: "รับค่าคอมมิชชัน 30% เมื่อแนะนำ UniScribe ให้ผู้ที่ต้องการถอดเสียงเสียงและวิดีโอ โน้ต AI และการส่งออกไฟล์",
      sections: [
        ["สำหรับผู้ชมที่เกี่ยวข้อง", "UniScribe ช่วยทีมและบุคคลเปลี่ยนการประชุม สัมภาษณ์ บทเรียน พอดแคสต์ และวิดีโอให้เป็นเอกสารที่ใช้งานได้"],
        ["เข้าร่วมโปรแกรม", "สร้างบัญชีพันธมิตร Rewardful และรับลิงก์แนะนำ UniScribe ของคุณ"],
        ["แชร์ UniScribe", "โปรโมตการถอดเสียง สรุป แผนผังความคิด การแปล คำบรรยาย และการส่งออกเอกสาร"],
      ...
      ctaText: "สร้างบัญชีพันธมิตร รับลิงก์ และเริ่มแชร์ UniScribe กับคนที่ทำงานกับเสียงและวิดีโอ",
      join: "เข้าร่วมโปรแกรมพันธมิตร",
      login: "เข้าสู่ระบบพันธมิตร",
      faqTitle: "พร้อมเป็นพันธมิตร UniScribe หรือยัง?",
  ...
  tr: {
    security: {
      ...
      description: "UniScribe'ın dosyalarınızı, transkriptlerinizi, paylaşım bağlantılarını ve ödemeleri nasıl koruduğunu öğrenin.",
      sections: [
        ...
        ["Ödemeler", "Ödemeler Stripe tarafından işlenir. UniScribe kart bilgilerinizi sunucularında saklamaz."],
    ...
    affiliate: {
      ...
      title: "UniScribe İş Ortaklığı Programı",
      description: "Ses ve video transkripsiyonu, AI notları ve dışa aktarma iş akışlarına ihtiyaç duyan kişilere UniScribe'ı tanıtarak %30 komisyon kazanın.",
      sections: [
        ["İlgili kitleler için", "UniScribe, toplantıları, röportajları, dersleri, podcastleri ve videoları kullanılabilir belgelere dönüştüren ekipler ve kişiler için faydalıdır."],
        ["Programa katılın", "Rewardful iş ortağı hesabınızı oluşturun ve benzersiz UniScribe referans bağlantınızı alın."],
        ["UniScribe'ı paylaşın", "Transkripsiyon, özetler, zihin haritaları, çeviri, altyazı ve belge dışa aktarımını tanıtın."],
      ...
      ctaText: "İş ortağı hesabınızı oluşturun, bağlantınızı alın ve UniScribe'ı ses ve video ile çalışan kişilerle paylaşmaya başlayın.",
      join: "İş ortaklığı programına katıl",
      login: "İş ortağı girişi",
      faqTitle: "UniScribe iş ortağı olmaya hazır mısınız?",
  ...
  uk: {
    security: {
      ...
      description: "Дізнайтеся, як UniScribe захищає ваші файли, транскрипції, посилання для поширення та платежі.",
      sections: [
        ...
        ["Платежі", "Платежі обробляє Stripe. UniScribe не зберігає дані картки на своїх серверах."],
    ...
    affiliate: {
      eyebrow: "Партнерство",
      title: "Партнерська програма UniScribe",
      description: "Заробляйте 30% комісії, рекомендуючи UniScribe людям, яким потрібні транскрипція аудіо й відео, AI-нотатки та експорт.",
      sections: [
        ["Для релевантної аудиторії", "UniScribe допомагає командам і людям перетворювати зустрічі, інтерв'ю, лекції, подкасти й відео на корисні документи."],
        ["Приєднатися", "Створіть партнерський акаунт Rewardful і отримайте унікальне посилання UniScribe."],
        ["Поширюйте UniScribe", "Просувайте транскрипцію, підсумки, ментальні карти, переклад, субтитри й експорт документів."],
      ...
      ctaText: "Створіть партнерський акаунт, отримайте посилання й поширюйте UniScribe серед людей, які працюють з аудіо та відео.",
      join: "Приєднатися до програми",
      login: "Вхід партнера",
      faqTitle: "Готові стати партнером UniScribe?",
  ...
  vi: {
    security: {
      ...
      description: "Tìm hiểu cách UniScribe bảo vệ tệp, bản chép lời, liên kết chia sẻ và thanh toán của bạn.",
      sections: [
        ...
        ["Thanh toán", "Stripe xử lý thanh toán. UniScribe không lưu thông tin thẻ trên máy chủ của mình."],
    ...
    affiliate: {
      ...
      title: "Chương trình affiliate UniScribe",
      description: "Kiếm 30% hoa hồng khi giới thiệu UniScribe cho người cần chép lời audio và video, ghi chú AI và xuất tài liệu.",
      sections: [
        ["Cho đúng đối tượng", "UniScribe giúp đội nhóm và cá nhân biến cuộc họp, phỏng vấn, bài giảng, podcast và video thành tài liệu hữu ích."],
        ["Tham gia chương trình", "Tạo tài khoản affiliate Rewardful và nhận liên kết giới thiệu UniScribe riêng của bạn."],
        ["Chia sẻ UniScribe", "Quảng bá chép lời, tóm tắt, sơ đồ tư duy, dịch, phụ đề và xuất tài liệu."],
      ...
      ctaText: "Tạo tài khoản affiliate, lấy liên kết và bắt đầu chia sẻ UniScribe với những người làm việc với audio và video.",
      join: "Tham gia chương trình",
      login: "Đăng nhập affiliate",
      faqTitle: "Sẵn sàng trở thành affiliate của UniScribe?",
  ...
  zh: {
    security: {
      eyebrow: "安全",
      title: "安全与隐私",
      description: "了解 UniScribe 如何保护你的文件、转写文本、分享链接和支付流程。",
      sections: [
        ["数据加密", "媒体文件和转写文本会在存储时加密，传输过程使用安全的 HTTPS 连接。"],
        ["账号访问", "文件默认归属你的账号。只有主动创建只读分享链接后，转写内容才会公开访问。"],
        ["支付安全", "支付由 Stripe 处理。UniScribe 不会在自己的服务器上保存银行卡信息。"],
    ...
    affiliate: {
      ...
      description: "把 UniScribe 推荐给需要音视频转写、AI 笔记和导出工作流的人，并获得 30% 佣金。",
      sections: [
        ["适合相关受众", "UniScribe 适合把会议、访谈、课程、播客和视频转成可用文档的团队和个人。"],
        ["加入计划", "创建 Rewardful 联盟账号，获取你的专属 UniScribe 推荐链接。"],
        ["分享 UniScribe", "推广转写、摘要、思维导图、翻译、字幕和文档导出工作流。"],
        ["赚取佣金", "在推荐客户前 12 个月的付款中获得 30% 佣金。"]
      ],
      stats: [["佣金", "30%", "基于推荐客户付款"], ["周期", "12 个月", "每位客户的佣金窗口"], ["追踪", "Rewardful", "推荐链接、转化、退款和付款追踪"]],
      ctaText: "创建你的联盟账号，获取链接，然后把 UniScribe 分享给处理音频和视频的人。",
      join: "加入联盟计划",
      login: "联盟登录",
      faqTitle: "准备成为 UniScribe 联盟伙伴？",
  ...
  "zh-TW": {
    security: {
      eyebrow: "安全",
      title: "安全與隱私",
      description: "了解 UniScribe 如何保護你的檔案、轉寫文字、分享連結和付款流程。",
      sections: [
        ["資料加密", "媒體檔案和轉寫文字會在儲存時加密，傳輸過程使用安全的 HTTPS 連線。"],
        ["帳號存取", "檔案預設歸屬你的帳號。只有主動建立唯讀分享連結後，轉寫內容才會公開存取。"],
        ["付款安全", "付款由 Stripe 處理。UniScribe 不會在自己的伺服器上保存信用卡資料。"],
        ["AI 處理邊界", "AI 服務商只接收完成目前任務所需的媒體或文字。未經明確同意，我們不會將你的資料用於 AI 訓練。"]
      ]
    },
    affiliate: {
      eyebrow: "聯盟計畫",
      title: "UniScribe 聯盟計畫",
      description: "將 UniScribe 推薦給需要音影片轉寫、AI 筆記與匯出流程的人，並獲得 30% 佣金。",
      sections: [
        ["適合相關受眾", "UniScribe 適合把會議、訪談、課程、Podcast 和影片轉成可用文件的團隊與個人。"],
        ["加入計畫", "建立 Rewardful 聯盟帳號，取得你的專屬 UniScribe 推薦連結。"],
        ["分享 UniScribe", "推廣轉寫、摘要、心智圖、翻譯、字幕和文件匯出流程。"],
        ["賺取佣金", "在推薦客戶前 12 個月的付款中獲得 30% 佣金。"]
      ],
      stats: [["佣金", "30%", "依推薦客戶付款計算"], ["週期", "12 個月", "每位客戶的佣金期間"], ["追蹤", "Rewardful", "推薦連結、轉換、退款與付款追蹤"]],
      ctaText: "建立你的聯盟帳號，取得連結，然後把 UniScribe 分享給處理音訊和影片的人。",
      join: "加入聯盟計畫",
      login: "聯盟登入",
      faqTitle: "準備成為 UniScribe 聯盟夥伴？",
          ...
          <>
            <div className="rounded-2xl border border-violet/15 bg-lavender p-6">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <a href="https://uniscribe.getrewardful.com" className="btn-primary">{affiliate.join}</a>
