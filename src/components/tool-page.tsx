...
const toolChromeByLocale: Partial<Record<Locale, ToolChrome>> = {
  en: {
    ...
    insightText: "Summarize long recordings, extract key points, create mind maps, and ask questions from the finished transcript without leaving Votxt.",
