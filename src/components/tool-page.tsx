...
const tools: ToolPageRecord[] = [
  ...
  },
  {
    ...
    eyebrow: "Tool",
    mode: "file",
    description: "Upload your audio and video files and quickly turn them into text with AI. Votxt also creates translations, summaries, and mind maps, and lets you export the text in different formats.",
  ...
  },
  {
    ...
    steps: [
      ...
      ["Click Transcribe", "Votxt checks the link and sends the media through the same transcription queue."],
  ...
  },
  {
    ...
    steps: [
      ...
      ["Choose Captions", "Votxt lists manual and automatic subtitles when the video provides them."],
  ...
  },
  {
    ...
    steps: [
      ...
      ["Download or Transcribe", "Use the extracted audio directly, or upload it to Votxt to generate text, subtitles, and summaries."]
    ],
    ...
    utilitySections: [
      ...
      ["Prepare files for captions", "Once the audio is ready, Votxt can create editable transcripts, subtitle files, summaries, translations, and share links."]
    ],
    faqs: [
  ...
  },
  {
    ...
    steps: [
      ...
      ["Use the MP3", "Download the MP3 or upload it to Votxt for transcription, captions, summaries, and exports."]
    ],
    ...
    utilitySections: [
      ...
      ["Keep export options open", "After transcription, Votxt can export TXT, DOCX, PDF, SRT, VTT, CSV, and shareable transcript pages."]
    ],
    faqs: [
  ...
  },
  {
    ...
    steps: [
      ...
      ["Download or Transcribe", "Open the media download link, or send the video into Votxt for transcript, subtitle, summary, and translation workflows."]
    ],
    ...
    utilitySections: [
      ...
      ["Continue into Votxt", "If you need searchable text instead of the raw video, send the link to Votxt for transcript and subtitle generation."]
    ],
    faqs: [
      ...
      ["Can I transcribe the video instead?", "Yes. Use the transcription action to send the same link into Votxt and create text, captions, summaries, and exports."]
    ]
  },
  {
    slug: "mp3-to-text",
    ...
    steps: [
      ...
      ["Click Transcribe", "Click Transcribe and wait for Votxt to process your audio."],
...
function genericToolPage(slug: string): ToolPageRecord {
  ...
  return {
    ...
    description: output
      ? `Convert recordings into ${output} with Votxt. Upload audio or video, generate an accurate transcript, then export it in the format you need.`
      : isSummaryPage
        ? "Turn meetings, classes, podcasts, and recordings into transcripts, summaries, mind maps, key points, and export-ready notes."
        : `Use Votxt for ${subject.toLowerCase()}. Upload audio or video, paste a public media link, generate text with AI, and export captions or documents.`,
...
const toolChromeByLocale: Partial<Record<Locale, ToolChrome>> = {
  en: {
    ...
    transcribeText: "Votxt creates an editable transcript with progress updates.",
    ...
    aiFastText: "With AI technology, you can quickly turn audio and video into text in just a few minutes. Votxt supports 63 languages and a range of formats.",
    insightText: "Summarize long recordings, extract key points, create mind maps without leaving Votxt.",
    ...
    reasonsTitle: "3 Reasons to Choose Votxt",
    reasonSaveTitle: "Spend a Little to Save a Lot on Audio-to-Text",
    reasonSaveText: "Votxt offers free monthly minutes, daily free files, and affordable paid plans when you need more.",
    ...
    reasonFastText: "Clear audio and the correct language setting help Votxt produce faster, more accurate transcripts.",
    ...
    genericFaqs: [["Can I use this for free?", "Yes. The Free plan includes monthly minutes, daily file limits, transcript editing, and standard exports."], ["Which files are supported?", "Votxt supports common audio and video formats including mp3, wav, m4a, flac, mp4, mov, mkv, webm, and wmv."], ["Can I export captions?", "Yes. Completed jobs export SRT and VTT, plus TXT, DOCX, PDF, CSV, and other transcript formats."]],
    languageFaqs: [["How do I transcribe this language?", "Upload your audio file, choose the right language, and start transcription. You can export the finished text in subtitle and document formats."], ["Can Votxt translate transcripts?", "Yes. After transcription, Votxt can generate AI translation and summary outputs."], ["Which export formats are available?", "TXT, DOCX, PDF, SRT, VTT, CSV, and structured exports are available for completed transcripts."]],
    bestTitle: "Best Practices for Audio & Video Transcription",
    bestText: "A few simple habits help Votxt return cleaner transcripts, captions, summaries, and exports.",
    ...
    useAfterTitle: "Use Votxt after conversion",
    useAfterText: "When the file is ready, send it into Votxt to create transcripts, subtitles, summaries, translations, mind maps, and shareable pages.",
...
Object.assign(toolChromeByLocale.de!, {
  ...
  transcribeText: "Votxt erstellt ein bearbeitbares Transkript und zeigt den Fortschritt an.",
  ...
  aiFastText: "Mit KI können Sie Audio und Video in wenigen Minuten in Text umwandeln. Votxt unterstützt 63 Sprachen und viele gängige Formate.",
  insightText: "Erstellen Sie Zusammenfassungen, Schlüsselpunkte, Mindmaps.",
  ...
  reasonSaveText: "Votxt bietet monatliche Freiminuten, kostenlose tägliche Dateien und bezahlbare Tarife.",
  ...
  reasonFastText: "Klare Audioqualität und die richtige Spracheinstellung helfen Votxt, schnellere und genauere Transkripte zu erzeugen.",
  ...
  genericFaqs: [["Kann ich es kostenlos nutzen?", "Ja. Der kostenlose Tarif enthält monatliche Minuten, tägliche Dateilimits, Bearbeitung und Standardexporte."], ["Welche Dateien werden unterstützt?", "Votxt unterstützt gängige Audio- und Videoformate wie mp3, wav, m4a, flac, mp4, mov, mkv, webm und wmv."], ["Kann ich Untertitel exportieren?", "Ja. Fertige Aufgaben können als SRT, VTT, TXT, DOCX, PDF und CSV exportiert werden."]],
  languageFaqs: [["Wie transkribiere ich diese Sprache?", "Laden Sie die Audiodatei hoch, wählen Sie die richtige Sprache und starten Sie die Transkription. Danach können Sie Untertitel oder Dokumente exportieren."], ["Kann Votxt Transkripte übersetzen?", "Ja. Nach der Transkription kann Votxt KI-Übersetzungen und Zusammenfassungen erstellen."], ["Welche Exportformate gibt es?", "TXT, DOCX, PDF, SRT, VTT, CSV und strukturierte Exporte sind verfügbar."]],
  ...
  useAfterTitle: "Votxt nach der Konvertierung verwenden",
  useAfterText: "Wenn die Datei bereit ist, senden Sie sie an Votxt, um Transkripte, Untertitel, Zusammenfassungen, Übersetzungen, Mindmaps und Freigabeseiten zu erstellen.",
      ...
      <section className="border-b border-violet/10 bg-lavender px-4 pb-14 pt-12 md:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_420px] lg:items-center">
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-xl border border-ink/10 bg-white shadow-lifted">
            <Image src="/votxt-assets/transcription.png" alt={`${pageTitle} workspace preview`} fill sizes="(min-width: 1024px) 420px, 100vw" className="object-cover object-top" priority />
          </div>
        </div>
        ...
        <section className="border-y border-ink/10 bg-white px-4 py-16 md:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div className="relative min-h-[300px] overflow-hidden rounded-xl border border-ink/10 bg-paper shadow-soft">
              <Image src="/votxt-assets/transcription.png" alt="Votxt transcription preview" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover object-top" />
            </div>
          </div>
        </section>
      ) : null}
      ...
      {!isLanguagePage && !isUtilityPage ? (
        <section className="px-4 py-16 md:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="relative min-h-[300px] overflow-hidden rounded-xl border border-ink/10 bg-paper shadow-soft">
              <Image src="/votxt-assets/summary.png" alt="Votxt AI summary preview" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover object-top" />
            </div>
            <div>
      ...
      {!isLanguagePage && !isUtilityPage ? (
        <section className="border-y border-ink/10 bg-white px-4 py-16 md:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div className="relative min-h-[300px] overflow-hidden rounded-xl border border-ink/10 bg-paper shadow-soft">
              <Image src="/votxt-assets/export.png" alt="Votxt export preview" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover object-top" />
            </div>
          </div>
        </section>
      ) : null}
