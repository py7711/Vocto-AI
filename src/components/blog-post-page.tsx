...
const blogPostPageCopy: Record<Locale, BlogPostPageCopy> = {
  ...
  es: {
    authorFallback: "Equipo de UniScribe",
  ...
  fr: {
    authorFallback: "Équipe UniScribe",
    tocTitle: "Sommaire",
  ...
  hu: {
    authorFallback: "UniScribe csapat",
  ...
  pl: {
    authorFallback: "Zespół UniScribe",
  ...
  pt: {
    authorFallback: "Equipe UniScribe",
    tocTitle: "Índice",
  ...
  ru: {
    authorFallback: "Команда UniScribe",
    tocTitle: "Содержание",
  ...
  tr: {
    authorFallback: "UniScribe ekibi",
  ...
  vi: {
    authorFallback: "Đội ngũ UniScribe",
    tocTitle: "Mục lục",
