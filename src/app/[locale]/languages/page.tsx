...
const languagesIndexCopy: Record<Locale, LanguagesIndexCopy> = {
  ar: {
    metaTitle: "اللغات المدعومة | UniScribe",
    eyebrow: "اللغات المدعومة",
    title: "تفريغ الصوت والفيديو بـ 63 لغة",
    description: "اختر دليل لغة للحصول على نصوص دقيقة وترجمات وملخصات وتصديرات من مساحة عمل UniScribe نفسها.",
  ...
  de: {
    metaTitle: "Unterstützte Sprachen | UniScribe",
    eyebrow: "Unterstützte Sprachen",
    title: "Audio und Video in 63 Sprachen transkribieren",
    description: "Wähle einen Sprachleitfaden für präzise Transkripte, Untertitel, Zusammenfassungen, Übersetzungen und Exporte im selben UniScribe-Arbeitsbereich.",
  ...
  en: {
    metaTitle: "Supported Languages | UniScribe",
    ...
    moreText: "After UniScribe creates the transcript, you can generate summaries, mind maps, key questions, translations, subtitle files, documents, and public share links."
  },
  es: {
    metaTitle: "Idiomas compatibles | UniScribe",
    eyebrow: "Idiomas compatibles",
    title: "Transcribe audio y video en 63 idiomas",
    description: "Elige una guía de idioma para obtener transcripciones, subtítulos, resúmenes, traducciones y exportaciones precisas en el mismo workspace de UniScribe.",
  ...
  fr: {
    metaTitle: "Langues prises en charge | UniScribe",
    eyebrow: "Langues prises en charge",
    title: "Transcrivez audio et vidéo dans 63 langues",
    description: "Choisissez un guide de langue pour obtenir transcriptions, sous-titres, résumés, traductions et exports dans le même espace UniScribe.",
  ...
  hu: {
    metaTitle: "Támogatott nyelvek | UniScribe",
    eyebrow: "Támogatott nyelvek",
    title: "Hang és videó átírása 63 nyelven",
    description: "Válassz nyelvi útmutatót pontos átiratokhoz, feliratokhoz, összefoglalókhoz, fordításokhoz és exportokhoz ugyanabban a UniScribe munkaterületben.",
  ...
  id: {
    metaTitle: "Bahasa yang didukung | UniScribe",
    eyebrow: "Bahasa yang didukung",
    title: "Transkripsi audio dan video dalam 63 bahasa",
    description: "Pilih panduan bahasa untuk transkrip, subtitle, ringkasan, terjemahan, dan ekspor yang akurat dari workspace UniScribe yang sama.",
  ...
  it: {
    metaTitle: "Lingue supportate | UniScribe",
    eyebrow: "Lingue supportate",
    title: "Trascrivi audio e video in 63 lingue",
    description: "Scegli una guida linguistica per trascrizioni, sottotitoli, riepiloghi, traduzioni ed esportazioni accurate nello stesso workspace UniScribe.",
  ...
  ja: {
    metaTitle: "対応言語 | UniScribe",
    eyebrow: "対応言語",
    title: "63 言語で音声と動画を文字起こし",
    description: "同じ UniScribe ワークスペースで、正確な文字起こし、字幕、要約、翻訳、エクスポートのための言語ガイドを選べます。",
    moreTitle: "文字起こし以上の機能",
    moreText: "文字起こし後に、要約、マインドマップ、重要な質問、翻訳、字幕ファイル、文書、公開共有リンクを生成できます。"
  },
  ko: {
    metaTitle: "지원 언어 | UniScribe",
    eyebrow: "지원 언어",
    title: "63개 언어로 오디오와 비디오 전사",
    description: "같은 UniScribe 워크스페이스에서 정확한 전사, 자막, 요약, 번역, 내보내기를 위한 언어 가이드를 선택하세요.",
    moreTitle: "전사 이상의 기능",
    moreText: "전사문이 생성된 뒤 요약, 마인드맵, 핵심 질문, 번역, 자막 파일, 문서, 공개 공유 링크를 만들 수 있습니다."
  },
  nl: {
    metaTitle: "Ondersteunde talen | UniScribe",
    eyebrow: "Ondersteunde talen",
    title: "Transcribeer audio en video in 63 talen",
    description: "Kies een taalgids voor nauwkeurige transcripties, ondertitels, samenvattingen, vertalingen en exports vanuit dezelfde UniScribe-workspace.",
  ...
  pl: {
    metaTitle: "Obsługiwane języki | UniScribe",
    eyebrow: "Obsługiwane języki",
    title: "Transkrybuj audio i wideo w 63 językach",
    description: "Wybierz przewodnik językowy dla dokładnych transkrypcji, napisów, podsumowań, tłumaczeń i eksportów w tym samym workspace UniScribe.",
  ...
  pt: {
    metaTitle: "Idiomas suportados | UniScribe",
    eyebrow: "Idiomas suportados",
    title: "Transcreva áudio e vídeo em 63 idiomas",
    description: "Escolha um guia de idioma para transcrições, legendas, resumos, traduções e exportações precisas no mesmo workspace UniScribe.",
  ...
  ru: {
    metaTitle: "Поддерживаемые языки | UniScribe",
    eyebrow: "Поддерживаемые языки",
    title: "Расшифровка аудио и видео на 63 языках",
    description: "Выберите языковой гид для точных расшифровок, субтитров, сводок, переводов и экспортов в одном рабочем пространстве UniScribe.",
  ...
  th: {
    metaTitle: "ภาษาที่รองรับ | UniScribe",
    eyebrow: "ภาษาที่รองรับ",
    title: "ถอดเสียงและวิดีโอได้ 63 ภาษา",
    description: "เลือกคู่มือภาษาเพื่อสร้างข้อความ คำบรรยาย สรุป คำแปล และไฟล์ส่งออกที่แม่นยำจากพื้นที่ทำงาน UniScribe เดียวกัน",
    moreTitle: "มากกว่าการถอดเสียง",
    moreText: "หลังจาก UniScribe สร้างข้อความแล้ว คุณสามารถสร้างสรุป แผนผังความคิด คำถามสำคัญ คำแปล ไฟล์คำบรรยาย เอกสาร และลิงก์แชร์สาธารณะ"
  },
  tr: {
    metaTitle: "Desteklenen diller | UniScribe",
    eyebrow: "Desteklenen diller",
    title: "Ses ve videoyu 63 dilde transkribe edin",
    description: "Aynı UniScribe çalışma alanında doğru transkriptler, altyazılar, özetler, çeviriler ve dışa aktarımlar için bir dil rehberi seçin.",
  ...
  uk: {
    metaTitle: "Підтримувані мови | UniScribe",
    eyebrow: "Підтримувані мови",
    title: "Транскрибуйте аудіо й відео 63 мовами",
    description: "Оберіть мовний гід для точних транскрипцій, субтитрів, підсумків, перекладів і експортів у тому самому просторі UniScribe.",
  ...
  vi: {
    metaTitle: "Ngôn ngữ hỗ trợ | UniScribe",
    eyebrow: "Ngôn ngữ hỗ trợ",
    title: "Chép lời audio và video bằng 63 ngôn ngữ",
    description: "Chọn hướng dẫn ngôn ngữ để có bản chép lời, phụ đề, tóm tắt, bản dịch và xuất tệp chính xác trong cùng workspace UniScribe.",
  ...
  zh: {
    metaTitle: "支持的语言 | UniScribe",
    eyebrow: "支持的语言",
    title: "支持 63 种语言的音视频转写",
    description: "选择语言指南，在同一个 UniScribe 工作台生成准确转写、字幕、摘要、翻译和导出文件。",
    moreTitle: "不止是转写",
    moreText: "UniScribe 创建转写后，你还可以生成摘要、思维导图、关键问题、翻译、字幕文件、文档和公开分享链接。"
  },
  "zh-TW": {
    metaTitle: "支援的語言 | UniScribe",
    eyebrow: "支援的語言",
    title: "支援 63 種語言的音影片轉寫",
    description: "選擇語言指南，在同一個 UniScribe 工作區產生準確轉寫、字幕、摘要、翻譯和匯出檔。",
    moreTitle: "不只是轉寫",
    moreText: "UniScribe 建立轉寫後，你還可以產生摘要、心智圖、關鍵問題、翻譯、字幕檔、文件和公開分享連結。"
  }
};
