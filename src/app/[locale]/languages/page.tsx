...
const languagesIndexCopy: Record<Locale, LanguagesIndexCopy> = {
  ...
  en: {
    ...
    moreText: "After Votxt creates the transcript, you can generate summaries, mind maps, translations, subtitle files, documents, and public share links."
  },
  es: {
    ...
    moreText: "Después de crear la transcripción, puedes generar resúmenes, mapas mentales, traducciones, subtítulos, documentos y enlaces públicos."
  },
  fr: {
    ...
    moreText: "Après la transcription, générez résumés, cartes mentales, traductions, sous-titres, documents et liens de partage publics."
  },
  hu: {
    ...
    moreText: "Az átirat elkészülte után összefoglalókat, gondolattérképeket, fordításokat, feliratokat, dokumentumokat és megosztási linkeket készíthetsz."
  },
  id: {
  ...
  it: {
    ...
    moreText: "Dopo la trascrizione puoi generare riepiloghi, mappe mentali, traduzioni, sottotitoli, documenti e link pubblici."
  },
  ja: {
  ...
  ko: {
    ...
    moreTitle: "전사 이상의 기능",
    moreText: "전사문이 생성된 뒤 요약, 마인드맵, 번역, 자막 파일, 문서, 공개 공유 링크를 만들 수 있습니다."
  },
  nl: {
    ...
    moreText: "Na de transcriptie kun je samenvattingen, mindmaps, vertalingen, ondertitelbestanden, documenten en openbare deellinks maken."
  },
  pl: {
    ...
    moreText: "Po utworzeniu transkrypcji możesz generować podsumowania, mapy myśli, tłumaczenia, napisy, dokumenty i publiczne linki."
  },
  pt: {
  ...
  ru: {
    ...
    moreText: "После создания текста можно получить сводки, интеллект-карты, переводы, субтитры, документы и публичные ссылки."
  },
  th: {
    ...
    moreText: "หลังจาก Votxt สร้างข้อความแล้ว คุณสามารถสร้างสรุป แผนผังความคิด คำแปล ไฟล์คำบรรยาย เอกสาร และลิงก์แชร์สาธารณะ"
  },
  tr: {
  ...
  uk: {
    ...
    moreText: "Після створення тексту можна генерувати підсумки, ментальні карти, переклади, субтитри, документи й публічні посилання."
  },
  vi: {
    ...
    moreText: "Sau khi có bản chép lời, bạn có thể tạo tóm tắt, sơ đồ tư duy, bản dịch, tệp phụ đề, tài liệu và liên kết chia sẻ công khai."
  },
  zh: {
    ...
    moreTitle: "不止是转写",
    moreText: "Votxt 创建转写后，你还可以生成摘要、思维导图、翻译、字幕文件、文档和公开分享链接。"
  },
  "zh-TW": {
    ...
    moreTitle: "不只是轉寫",
    moreText: "Votxt 建立轉寫後，你還可以產生摘要、心智圖、翻譯、字幕檔、文件和公開分享連結。"
  }
};
